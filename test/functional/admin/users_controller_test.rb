...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, :admin_user => { :login => @admin_user.login, :password_digest => @admin_user.password_digest }
    end
  ...
  test "should update admin_user" do
    put :update, :id => @admin_user, :admin_user => { :login => @admin_user.login, :password_digest => @admin_user.password_digest }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
